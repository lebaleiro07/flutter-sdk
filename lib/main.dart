...
import 'package:music_playce_sdk/core/api/repositories/impl/blog_repository_impl.dart';
...
import 'core/api/repositories/blog_repository.dart';
...
class MusicPlayceSdk {
  void registerSingletons(Environment environment) {
    ...
    GetIt.instance.registerSingleton<BlogRepository>(
        BlogRepositoryImpl(httpClient: _musicPlayceHttp));
